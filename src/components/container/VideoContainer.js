...
export class VideoContainer extends Component {
	componentWillUpdate(nextProps) {
		...
		const sameSearchHappened =
			search.sameSearchTrigger !== nextProps.search.sameSearchTrigger;
				...
				<div className="video-container animated bounceIn loading-bg">
					<div className="inner-video-border">
						<div className="loader">
							...
							<div className="line" />
							<div className="line" />
							<div className="wait-text">Please search for something...</div>
						</div>
					</div>
				</div>
			);
...
const mapDispatchToProps = dispatch => {
	return {
		setVideoPlayer: eventTarget =>
			dispatch(videoActions.setVideoPlayer(eventTarget)),
